...
const kodeMurid = document.querySelector("#km");
...
changeLine(password2, kodeMurid);
changeLine(kodeMurid, daftarBtn);
...
daftarBtn.addEventListener("click", function (event) {
  if (NIK.value == "" || username.value == "" || namaLengkap.value == "" || password.value == "" || email.value == "" || password2.value == "") {
    event.preventDefault();
